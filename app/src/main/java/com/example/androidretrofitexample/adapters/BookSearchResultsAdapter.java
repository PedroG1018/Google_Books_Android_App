package com.example.androidretrofitexample.adapters;
...
import com.example.androidretrofitexample.models.Volume;
import com.example.androidretrofitexample.util.Util;

import java.util.ArrayList;
import java.util.List;

public class BookSearchResultsAdapter extends RecyclerView.Adapter<BookSearchResultsAdapter.BookSearchResultsHolder> {
    ...
    public class BookSearchResultsHolder extends RecyclerView.ViewHolder {
